...
test('GitHub connector maps commits and workflow runs without exposing token', async () => {
  ...
  const client = new GitHubClient({
    ...
    fetchImpl: async (url, options) => {
      ...
      return response([{ number: 3, title: 'Analysis update', state: 'closed', draft: false, merged_at: '2026-01-01T00:00:00Z', head: { sha: 'abc' }, base: { ref: 'main' }, updated_at: '2026-01-01T00:00:00Z', html_url: 'https://github.test/p/3' }]);
    }
  });
